...
#This web controller will create a web server that is capable
    ...
    # RP2040 sensor board (gyro, accel, euler, odom, motor encoders)
    if getattr(cfg, 'HAVE_RP2040', False):
        from donkeycar.parts.rp2040_sensor import RP2040SensorPart, RP2040_OUTPUT_NAMES
        rp2040 = RP2040SensorPart(
            port=getattr(cfg, 'RP2040_SERIAL_PORT', '/dev/ttyACM0'),
            baudrate=getattr(cfg, 'RP2040_BAUDRATE', 115200))
        V.add(rp2040, outputs=RP2040_OUTPUT_NAMES, threaded=True)
    ...
    # RP2040 sensor recording
    if getattr(cfg, 'HAVE_RP2040', False):
        from donkeycar.parts.rp2040_sensor import RP2040_OUTPUT_NAMES, RP2040_OUTPUT_TYPES
        inputs += RP2040_OUTPUT_NAMES
        types += RP2040_OUTPUT_TYPES
