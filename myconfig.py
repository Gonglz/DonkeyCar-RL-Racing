...
EARLY_STOP_PATIENCE = 15         #how many epochs to wait before no improvement
...
DONKEY_GYM = True
DONKEY_SIM_PATH = "/home/longzhao/Car/DonkeySimLinux/donkey_sim.x86_64"
...
#
# # Dynamics alignment for sim2real transfer
# # Set SIM_DYNAMICS_ALIGNMENT = True to use dynamics_wrapper.py instead of dgym.py
# # SIM_DYNAMICS_JSON points to the output of tools/dynamics_id.py
# SIM_DYNAMICS_ALIGNMENT = False
# SIM_DYNAMICS_JSON = "dynamics_data/params/dynamics_params.json"

# RP2040 sensor board — records gyro, accel, euler, odom, motor encoders
# into tub alongside images and steering/throttle. No extra script needed.
# HAVE_RP2040 = True
# RP2040_SERIAL_PORT = "/dev/ttyACM0"
